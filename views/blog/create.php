    <div class="container">
        ...
        <f3:check if="{{ @message  }}">
                ...
                </f3:check>        <form action="{{ @BASE }}/blog/create" method="POST">
            <div class="form-group">
                <div class="row">
                    ...
                    <!-- <div class="col-6">
                        <label for="excerpt">Fragmento</label>
                        <input type="text" class="form-control" id="excerpt" name="excerpt" placeholder="Fragmento del contenido" value="{{ @POST.excerpt }}">
                    </div> -->
                </div>
